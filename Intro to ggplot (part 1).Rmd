...
Visualizing any data set using the Grammar of Graphics requires use of the following components:

* Data columns
* Geoms
* Scales

Data columns are of course self-explanatory.  **Geoms** are the visual entities that we see on a graph. 
...
**Scales** specify how the data are translated to geoms.   Examples of scales in `ggplot2` are:
